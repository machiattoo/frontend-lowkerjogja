...
<div class="home">
    ...
    <div class="jumbotron jumbotron-fluid d-flex align-items-center">
        <div class="container">
            <h2>PORTAL LOWONGAN KERJA ONLINE NO 1 <br>
                DIJOGJA DAN SEKITARNYA</h2>
            <p>Awali karir profesionalmu mulai sekarang. <br>Download aplikasi LOWKERJOGJA untuk
                akses yang lebih mudah di Play Store atau App Store.</p>
            <a href="/pages/download" class="btn btn-success">Download Aplikasi</a>
        </div>
    </div>
    <!-- End jumbotron -->
            ...
            <div class="d-flex flex-column">
                <form action="/pages/cari" method="post">
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <select id="inputState" class="form-control" name="penempatan">
    ...
    <div class="isi py-5">
        ...
        <div class="text-center p-5">
            <h1>JOB FAIR EVERYDAY</h1>
            <div class="p">Jangan lupa untuk bergabung juga dengan ratusan ribu komunitas job seeker di sosial media LOWKERJOGJA</div>
        </div>
        <br><br>
        <div class="container">
